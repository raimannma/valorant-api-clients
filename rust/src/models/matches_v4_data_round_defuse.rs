...
impl MatchesV4DataRoundDefuse {
    pub fn new(location: models::MatchesV4DataRoundLocation, player: models::MatchesV4DataRoundPlayer, player_locations: Vec<models::MatchesV4DataRoundPlayerLocations>, round_time_in_ms: i32) -> MatchesV4DataRoundDefuse {
