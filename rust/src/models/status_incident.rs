...
impl StatusIncident {
    pub fn new(created_at: String, id: u32, incident_severity: String, platforms: Vec<String>, titles: Vec<models::StatusIncidentContent>, updates: Vec<models::StatusIncidentUpdate>) -> StatusIncident {
        StatusIncident {
            archive_at: None,
            created_at,
            id,
