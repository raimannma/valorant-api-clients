...
// tests for EsportsV2TransactionPlayer
void main() {
  // final instance = EsportsV2TransactionPlayer();

  group('test EsportsV2TransactionPlayer', () {
    // String alias
    ...
    // String realName
    test('to test the property `realName`', () async {
      // TODO
    });
