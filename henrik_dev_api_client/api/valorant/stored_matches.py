...
from ...models.stored_matches_response import StoredMatchesResponse
...
) -> Optional[Union[SendError, StoredMatchesResponse]]:
    if response.status_code == 200:
        response_200 = StoredMatchesResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[SendError, StoredMatchesResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[SendError, StoredMatchesResponse]
    """
