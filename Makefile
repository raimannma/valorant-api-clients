...
python:
	...
	pnpx @openapitools/openapi-generator-cli generate -i https://api.henrikdev.xyz/openapi.json -g python -o python/ --skip-validate-spec --additional-properties=packageName=henrikdev_api_client
...
typescript:
	...
	pnpx @openapitools/openapi-generator-cli generate -i https://api.henrikdev.xyz/openapi.json -g typescript-axios -o typescript/ --skip-validate-spec --additional-properties=npmName=henrikdev_api_client,useSingleRequestParameter=true
...
rust:
	...
	pnpx @openapitools/openapi-generator-cli generate -i https://api.henrikdev.xyz/openapi.json -g rust -o rust/ --skip-validate-spec --additional-properties=packageName=henrikdev_api_client,useSingleRequestParameter=true,preferUnsignedInt=true,bestFitInt=true
...
kotlin:
	...
	pnpx @openapitools/openapi-generator-cli generate -i https://api.henrikdev.xyz/openapi.json -g kotlin -o kotlin/ --skip-validate-spec --additional-properties=packageName=henrikdevApiClient,idea=true,artifactId=henrikdev_api_client,groupId=xyz.henrikdev.api,artifactUrl=https://github.com/Henrik-3/valorant-api-clients
...
dart:
	...
	pnpx @openapitools/openapi-generator-cli generate -i https://api.henrikdev.xyz/openapi.json -g dart -o dart/ --skip-validate-spec  --additional-properties=pubName=henrikdev_api_client,pubLibrary=henrikdev_api_client,pubAuthor=henrikdev,pubHomepage=https://henrikdev.xyz,pubRepository=https://github.com/raimannma/valorant-api-clients
