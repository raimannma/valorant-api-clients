...
class StatusIncidentUpdate(BaseModel):
    ...
    publish: StrictBool
    publish_locations: List[StrictStr]
    translations: List[StatusIncidentContent]
    updated_at: StrictStr
    __properties: ClassVar[List[str]] = ["author", "created_at", "id", "publish", "publish_locations", "translations", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "publish_locations": obj.get("publish_locations"),
            "translations": [StatusIncidentContent.from_dict(_item) for _item in obj["translations"]] if obj.get("translations") is not None else None,
