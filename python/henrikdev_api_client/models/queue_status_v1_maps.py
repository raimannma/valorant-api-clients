...
class QueueStatusV1Maps(BaseModel):
    """
    QueueStatusV1Maps
    """ # noqa: E501
    enabled: StrictBool
    map: QueueStatusV1Map
    __properties: ClassVar[List[str]] = ["enabled", "map"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "map": QueueStatusV1Map.from_dict(obj["map"]) if obj.get("map") is not None else None
        })
        return _obj
