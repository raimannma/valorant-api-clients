...
class EsportsV2TeamPastMatches(BaseModel):
    """
    EsportsV2TeamPastMatches
    """ # noqa: E501
    matches: List[EsportsV2PastMatch]
    team: Annotated[int, Field(strict=True, ge=0)]
    __properties: ClassVar[List[str]] = ["matches", "team"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "matches": [EsportsV2PastMatch.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None,
            "team": obj.get("team")
        })
        return _obj
