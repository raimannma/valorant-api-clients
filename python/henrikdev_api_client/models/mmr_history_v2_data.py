...
class MMRHistoryV2Data(BaseModel):
    """
    MMRHistoryV2Data
    """ # noqa: E501
    account: MMRV3Account
    history: List[MMRHistoryV2History]
    __properties: ClassVar[List[str]] = ["account", "history"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "history": [MMRHistoryV2History.from_dict(_item) for _item in obj["history"]] if obj.get("history") is not None else None
        })
        return _obj
