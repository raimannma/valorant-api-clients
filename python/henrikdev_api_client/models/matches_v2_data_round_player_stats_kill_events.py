...
class MatchesV2DataRoundPlayerStatsKillEvents(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["assistants", "damage_weapon_assets", "damage_weapon_id", "damage_weapon_name", "kill_time_in_match", "kill_time_in_round", "killer_display_name", "killer_puuid", "killer_team", "player_locations_on_kill", "secondary_fire_mode", "victim_death_location", "victim_display_name", "victim_puuid", "victim_team"]
