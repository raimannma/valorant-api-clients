...
class EsportsV2MatchEconomy(BaseModel):
    """
    EsportsV2MatchEconomy
    """ # noqa: E501
    teams: List[EsportsV2TeamEconomy]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "teams": [EsportsV2TeamEconomy.from_dict(_item) for _item in obj["teams"]] if obj.get("teams") is not None else None
        })
        return _obj
