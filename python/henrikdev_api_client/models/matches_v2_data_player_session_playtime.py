...
class MatchesV2DataPlayerSessionPlaytime(BaseModel):
    """
    MatchesV2DataPlayerSessionPlaytime
    """ # noqa: E501
    milliseconds: Annotated[int, Field(strict=True, ge=0)]
    minutes: Annotated[int, Field(strict=True, ge=0)]
    seconds: Annotated[int, Field(strict=True, ge=0)]
    __properties: ClassVar[List[str]] = ["milliseconds", "minutes", "seconds"]
