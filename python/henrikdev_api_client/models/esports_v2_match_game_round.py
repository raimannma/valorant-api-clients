...
class EsportsV2MatchGameRound(BaseModel):
    """
    EsportsV2MatchGameRound
    """ # noqa: E501
    round: Annotated[int, Field(strict=True, ge=0)]
    winning_site: StrictStr
    winning_team: Annotated[int, Field(strict=True, ge=0)]
    __properties: ClassVar[List[str]] = ["round", "winning_site", "winning_team"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "round": obj.get("round"),
            "winning_site": obj.get("winning_site"),
