...
class EsportsV2HeadToHeadMatch(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["date", "event", "match", "score"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "event": EsportsV2HeadToHeadEvent.from_dict(obj["event"]) if obj.get("event") is not None else None,
            "match": EsportsV2IdSlug.from_dict(obj["match"]) if obj.get("match") is not None else None,
            "score": EsportsV2HeadToHeadScore.from_dict(obj["score"]) if obj.get("score") is not None else None
        })
        return _obj
