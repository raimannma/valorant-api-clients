...
class MMRV1Data(BaseModel):
    ...
    tag: StrictStr
    __properties: ClassVar[List[str]] = ["currenttier", "currenttierpatched", "elo", "images", "mmr_change_to_last_game", "name", "old", "ranking_in_tier", "tag"]
