...
class MatchesV4DataTeamPremierRosterCustomization(BaseModel):
    """
    ...
    secondary_color: StrictStr
    tertiary_color: StrictStr
    __properties: ClassVar[List[str]] = ["icon", "image", "primary_color", "secondary_color", "tertiary_color"]
