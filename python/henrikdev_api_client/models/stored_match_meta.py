...
class StoredMatchMeta(BaseModel):
    """
    StoredMatchMeta
    """ # noqa: E501
    ...
    version: StrictStr
    __properties: ClassVar[List[str]] = ["cluster", "id", "map", "mode", "region", "season", "started_at", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "map": StoredMatchMetaMap.from_dict(obj["map"]) if obj.get("map") is not None else None,
            "mode": obj.get("mode"),
            "region": obj.get("region"),
            "season": StoredMatchMetaSeason.from_dict(obj["season"]) if obj.get("season") is not None else None,
