...
class EsportsV2MatchHeader(BaseModel):
    """
    ...
    patch: StrictStr
    status: StrictStr
    __properties: ClassVar[List[str]] = ["date", "event", "format", "note", "patch", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "event": EsportsV2MatchEvent.from_dict(obj["event"]) if obj.get("event") is not None else None,
