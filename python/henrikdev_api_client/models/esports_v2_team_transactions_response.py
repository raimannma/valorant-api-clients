...
class EsportsV2TeamTransactionsResponse(BaseModel):
    """
    EsportsV2TeamTransactionsResponse
    """ # noqa: E501
    data: List[EsportsV2TeamTransaction]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [EsportsV2TeamTransaction.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
