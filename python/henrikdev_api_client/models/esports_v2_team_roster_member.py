...
class EsportsV2TeamRosterMember(BaseModel):
    """
    ...
    role: StrictStr
    __properties: ClassVar[List[str]] = ["alias", "avatar", "country_code", "id", "is_captain", "real_name", "role"]
