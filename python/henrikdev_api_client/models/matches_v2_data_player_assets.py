...
class MatchesV2DataPlayerAssets(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agent": MatchesV2DataPlayerAssetsAgent.from_dict(obj["agent"]) if obj.get("agent") is not None else None,
            "card": MatchesV2DataPlayerAssetsCard.from_dict(obj["card"]) if obj.get("card") is not None else None
        })
        return _obj
