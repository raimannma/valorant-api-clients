...
class MatchesV2DataRoundPlayerStatsEconomyEquipmentWeapon(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assets": MatchesV2DataRoundPlayerStatsEconomyEquipmentAssets.from_dict(obj["assets"]) if obj.get("assets") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name")
        })
        return _obj
