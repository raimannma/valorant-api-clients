...
class EsportsV2TeamMatchListResponse(BaseModel):
    """
    EsportsV2TeamMatchListResponse
    """ # noqa: E501
    data: List[EsportsV2TeamMatch]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [EsportsV2TeamMatch.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
