...
class EsportsV2PlacementEntry(BaseModel):
    """
    EsportsV2PlacementEntry
    """ # noqa: E501
    placement: StrictStr
    prize: Optional[StrictStr] = None
    stage: StrictStr
    team: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["placement", "prize", "stage", "team"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if prize (nullable) is None
        # and model_fields_set contains the field
        if self.prize is None and "prize" in self.model_fields_set:
            _dict['prize'] = None
