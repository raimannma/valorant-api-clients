...
class StoredMatch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["meta", "stats", "teams"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meta": StoredMatchMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "stats": StoredMatchStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None,
            "teams": StoredMatchTeam.from_dict(obj["teams"]) if obj.get("teams") is not None else None
        })
        return _obj
