...
class LeaderboardV3Data(BaseModel):
    """
    LeaderboardV3Data
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["players", "thresholds", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "players": [LeaderboardV3DataPlayer.from_dict(_item) for _item in obj["players"]] if obj.get("players") is not None else None,
            "thresholds": [LeaderboardV3DataThreshold.from_dict(_item) for _item in obj["thresholds"]] if obj.get("thresholds") is not None else None,
