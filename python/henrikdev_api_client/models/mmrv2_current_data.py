...
class MMRV2CurrentData(BaseModel):
    """
    MMRV2CurrentData
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["currenttier", "currenttierpatched", "elo", "games_needed_for_rating", "images", "mmr_change_to_last_game", "old", "ranking_in_tier"]
