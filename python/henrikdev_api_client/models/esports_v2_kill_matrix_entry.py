...
class EsportsV2KillMatrixEntry(BaseModel):
    """
    EsportsV2KillMatrixEntry
    """ # noqa: E501
    deaths: Annotated[int, Field(strict=True, ge=0)]
    killer: Annotated[int, Field(strict=True, ge=0)]
    kills: Annotated[int, Field(strict=True, ge=0)]
    victim: Annotated[int, Field(strict=True, ge=0)]
    __properties: ClassVar[List[str]] = ["deaths", "killer", "kills", "victim"]
