...
class LeaderboardV3DataThreshold(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["start_index", "threshold", "tier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tier": LeaderboardV3DataThresholdTier.from_dict(obj["tier"]) if obj.get("tier") is not None else None
        })
        return _obj
