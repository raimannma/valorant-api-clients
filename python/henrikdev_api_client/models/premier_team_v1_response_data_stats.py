...
class PremierTeamV1ResponseDataStats(BaseModel):
    """
    PremierTeamV1ResponseDataStats
    """ # noqa: E501
    losses: StrictInt
    matches: StrictInt
    rounds_lost: StrictInt
    rounds_won: StrictInt
    wins: StrictInt
    __properties: ClassVar[List[str]] = ["losses", "matches", "rounds_lost", "rounds_won", "wins"]
