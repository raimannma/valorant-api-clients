...
class TestMatchesV2DataPlayer(unittest.TestCase):
    """MatchesV2DataPlayer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchesV2DataPlayer:
        ...
        """
        model = MatchesV2DataPlayer()
        if include_optional:
            return MatchesV2DataPlayer(
    ...
    def testMatchesV2DataPlayer(self):
        """Test MatchesV2DataPlayer"""
