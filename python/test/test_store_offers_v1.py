...
class TestStoreOffersV1(unittest.TestCase):
    """StoreOffersV1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StoreOffersV1:
        """Test StoreOffersV1
