...
class TestMatchesV2DataKill(unittest.TestCase):
    """MatchesV2DataKill unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchesV2DataKill:
        """Test MatchesV2DataKill
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchesV2DataKill`
        """
        model = MatchesV2DataKill()
        if include_optional:
            return MatchesV2DataKill(
                assistants = [
    ...
    def testMatchesV2DataKill(self):
        """Test MatchesV2DataKill"""
