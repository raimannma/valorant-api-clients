...
class TestMatchesV2Data(unittest.TestCase):
    """MatchesV2Data unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchesV2Data:
        """Test MatchesV2Data
